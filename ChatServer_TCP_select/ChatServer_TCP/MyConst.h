...
{
public:
	static const int LOGIN_PKT = 1;
	static const int LOGOUT_PKT = 2;
	static const int LOGIN_REPLY_PKT = 3;
	static const int PUBLIC_CHAT_PKT = 4;
	static const int PRIVATE_CHAT_PKT = 5;
	static const int SYSTEM_PKT = 6;
	
	static const int STATE_UNLOGIN = 101;
	static const int STATE_LOGINED = 100;
	...
	static const int MAX_USER_NUM = 63;


	static const int MESSAGE_GET = 100;

	static const int MESSAGE_UNGET = -100;
};
